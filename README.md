...
Le rapport est généré dans `front/coverage/front/index.html`. Karma bloque la validation si la couverture globale descend sous 70 % des instructions ou des lignes.
